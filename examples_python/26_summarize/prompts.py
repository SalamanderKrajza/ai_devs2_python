def get_prompt(file_name, file_author):
    return f"""As a researcher, your job is to make a quick note based on the fragment provided by the user, that comes from the document: "{file_name}".
    ...
    - Always use natural, casual tone from YouTube tutorials, as if you were speaking with the friend of {file_author}
